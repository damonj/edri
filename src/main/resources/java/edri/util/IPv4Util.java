...
public class IPv4Util {
    ...
    public static void showAll(){
        ...
        log.debug(ipAndMask + " --> int地址段：[ " + ipscope[0] + ","
                + ipscope[1] + " ]");
        log.debug(ipAndMask + " --> IP 地址段：[ "
        ...
        log.debug(ipAddr1 + " , " + ipMask1 + "  --> int地址段 ：[ "
                + ipscope1[0] + "," + ipscope1[1] + " ]");
        log.debug(ipAddr1 + " , " + ipMask1 + "  --> IP地址段 ：[ "
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println(ipAndMask + " --> int地址段：[ " + (Math.pow(2, 31) - ipscope[0]) + ","
                + (Math.pow(2, 31) - ipscope[1]) + " ]");

        System.out.println(ipAndMask + " --> int地址段：[ " + Integer.toBinaryString(ipscope[0]) + ","
